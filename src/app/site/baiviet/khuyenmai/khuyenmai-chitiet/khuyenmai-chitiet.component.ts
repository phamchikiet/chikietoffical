...
@Component({
  selector: 'app-khuyenmai-chitiet',
  templateUrl: './khuyenmai-chitiet.component.html',
  styleUrls: ['./khuyenmai-chitiet.component.css']
})
export class KhuyenmaiChitietComponent implements OnInit {
