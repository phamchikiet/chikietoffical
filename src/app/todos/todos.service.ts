    ...
    try {
      const options = {
        ...
        headers: {
          ...
          const response = await fetch(`${environment.APIURL}/todos`,options);
          const data = await response.json(); 
    ...
    try {
      const options = {
        ...
        headers: {
          ...
          const response = await fetch(`${environment.APIURL}/todos/findslug/${Slug}`,options);
          const data = await response.json();    
    ...
    try {
      const options = {
        ...
        headers: {
          ...
          const response = await fetch(`${environment.APIURL}/todos/findid/${id}`,options);
          if (!response.ok) {
    ...
    try {
      const options = {
        ...
        body: JSON.stringify(SearchParams),
          ...
          const response = await fetch(`${environment.APIURL}/todos/search`,options);
          if (!response.ok) {
            throw new Error(`HTTP error! status: ${response.status}`);
          }
          const data = await response.json();   
  ...
  async SyncTodos(item:any) {
    try {
        const options = {
          ...
          const response = await fetch(`${environment.APIURL}/todos/sync`, options);          
          if (!response.ok) {
            throw new Error(`HTTP error! status: ${response.status}`);
          }
          const data = await response.json();  
  ...
  async UpdateTodos(item:any) {
    ...
    try {
        const options = {
          ...
          const response = await fetch(`${environment.APIURL}/todos/${item.id}`, options);
          if (!response.ok) {
            throw new Error(`HTTP error! status: ${response.status}`);
          }
          const data = await response.json();
